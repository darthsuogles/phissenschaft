...
void printHelpInfo()
{
    std::cout << "Usage: ./sample_googlenet [-h or --help] [-d or --datadir=<path to data directory>]\n";
    ...
    std::cout << "--useDLA   Enable execution on DLA for all layers that support dla. Value can range from 1 to N, where N is the number of dla engines on the platform." << std::endl;
}
