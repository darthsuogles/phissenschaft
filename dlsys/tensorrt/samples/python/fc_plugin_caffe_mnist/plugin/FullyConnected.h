...
public:
	...
	virtual const char* getPluginType() const override { return "FCPlugin_TRT"; }
	...
	{
		nvinfer1::Weights weights[2] = {mKernelWeights, mBiasWeights};
		return new FCPlugin{weights, 2};
	}
...
public:
	...
	void destroyPlugin() { mPlugin->destroy(); }
